...
class LimitOrderProtocolFacade {
    ...
    fillOrderToWithPermit(params) {
        const { order, signature, makerAmount, takerAmount, thresholdAmount, targetAddress, permit } = params;
        return this.getContractCallData(limit_order_protocol_model_1.LimitOrderProtocolMethods.fillOrderToWithPermit, [order, signature, makerAmount, takerAmount, thresholdAmount, targetAddress, permit]);
    }
