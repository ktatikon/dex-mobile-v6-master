import { ChainId, LimitOrder, LimitOrderProtocolMethods, LimitOrderData, LimitOrderHash, LimitOrderSignature, RFQOrder, RFQOrderData } from './model/limit-order-protocol.model';
...
export declare class LimitOrderBuilder {
    ...
    buildRFQOrder({ id, wrapEth, expiresInTimestamp, makerAssetAddress, takerAssetAddress, makerAddress, takerAddress, makerAmount, takerAmount, }: RFQOrderData): RFQOrder;
    buildLimitOrder({ makerAssetAddress, takerAssetAddress, makerAddress, receiver, takerAddress, makerAmount, takerAmount, predicate, permit, interaction, }: LimitOrderData): LimitOrder;
